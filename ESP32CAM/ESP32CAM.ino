//conexao com wifi
const char* ssid     = "VIRUS666";   //your network SSID
const char* password = "33264672(!@#)";   //your network password
...
//import libs
#include <WiFi.h>
#include <esp32-hal-ledc.h>      //Usado para controlar servo motores
#include "soc/soc.h"             //Usado para fonte de alimentação instável sem reinicialização 
#include "soc/rtc_cntl_reg.h"    //Usado para fonte de alimentação instável sem reinicialização

#include "esp_camera.h"          //lib pattern
#include "esp_http_server.h"     //HTTP Server
#include "esp_timer.h"           //lib cronometro
#include "img_converters.h"      //Biblioteca de conversão de formato de imagem
#include "fb_gfx.h"              //Biblioteca de desenho de imagens
#include "fd_forward.h"          //Biblioteca de detecção de rosto


/*String Feedback="";//Comando personalizado para retornar mensagem do cliente

//Valor do parâmetro de comando personalizado
String Command="";
String cmd="";
String P1="";
String P2="";
...
////Valor do status de desmontagem do comando personalizado
byte ReceiveState=0;
byte cmdState=1;
byte strState=1;
...
//ESP32-CAM模組腳位設定 - Configuração do pino do módulo
...
void setup() {
  ...
  //視訊組態設定 - Definições de configuração de vídeo
